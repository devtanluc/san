...
import { Bubble, BubbleContent } from "@san/ui/components/bubble";
...
import {
  ...
  EmptyMedia,
  EmptyTitle,
} from "@san/ui/components/empty";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@san/ui/components/input-group";
import { Message, MessageContent as MessageBody, MessageHeader } from "@san/ui/components/message";
import {
  MessageScroller,
...
} from "@san/ui/components/message-scroller";
import { Tooltip, TooltipContent, TooltipTrigger } from "@san/ui/components/tooltip";
          ...
          {messages.length === 0 && !isSending ? (
            <Empty className="mx-auto h-full max-w-3xl px-4">
              <EmptyHeader>
                ...
                <EmptyTitle>Morning, san!</EmptyTitle>
